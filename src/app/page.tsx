        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              🌙 Born in the Glow of{" "}
              <span className="text-blue-500">Moroccan</span> Evenings.
            </h1>

            <p className="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              What began as evening lessons in every Moroccan neighborhood now
              thrives online. Scholora connects students with expert tutors who
              understand our culture, struggles, and dreams. This is Morocco’s
              new way to learn — smarter, prouder, and limitless.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 items-center">
              ...
              >
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition-all duration-200 disabled:opacity-50"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From signup to your first session in minutes. We make quality
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Meet Our Morocco’s Premier Tutors
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              We're assembling an extraordinary team of educators, innovators,
              and subject matter experts. Their identities will be revealed when
              we launch - but their expertise is already legendary.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Link href="/tutors">
              <div className="bg-white rounded-xl border border-gray-200 p-6 text-center hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer">
                ...
                <div className="text-sm text-gray-600 mb-1">
                  <b>Level:</b> University Preparation
                </div>
                <div className="text-sm text-blue-600 font-medium mb-4">
                  ENSET Professor
                </div>
            ...
            <Link href="/tutors">
              <div className="bg-white rounded-xl border border-gray-200 p-6 text-center hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer">
                ...
                <div className="text-sm text-blue-600 font-medium mb-4">
                  ENCG Master Commerce International
                </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mb-2">
              We're onboarding world-class educators across every subject
              imaginable.
            </p>
            <p className="text-sm text-gray-600">
              Their profiles unlock when we launch.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="success-stories" className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Word travels fast in academic circles. Here's what industry
              leaders are quietly saying about the team we're assembling.
            </p>
          </div>
            ...
            <div className="overflow-hidden rounded-2xl">
              ...
              >
                {[
                  {
                    quote:
                      "Vous êtes le meilleur Monsieur, grâce à vous j'ai repris goût au développement",
                    name: "Student",
                  ...
                  {
                    quote:
                      "Je confirme 20 / 20 en contrôle continu et national grâce à Dieu et prof ....",
                    name: "Student",
                    role: "2BAC Physic",
                    color: "bg-blue-500",
                  },
                  ...
                  <div key={index} className="w-1/3 flex-shrink-0 px-4">
                    <div className="bg-white rounded-lg p-6 border border-gray-200">
                      <div className="flex items-start mb-4">
                        <div
                          className={`w-12 h-12 ${testimonial.color} rounded-full flex items-center justify-center mr-3 flex-shrink-0`}
                        >
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-gray-600 mb-2">
              "These are just whispers. Wait until you see what they can
              actually do."
            </p>
            <p className="text-sm font-medium text-blue-600">
              Pre-expert profiles unlock at launch
            </p>
          </div>
        </div>
      </section>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-white/90 max-w-4xl mx-auto leading-relaxed">
                We're crafting an AI-powered learning experience that will
                redefine education. Get ready for personalized tutoring like
                never before.
              </p>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              We're building something extraordinary. Here's a glimpse of the
              subjects and experiences that will be available when we launch.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              {
                subject: "SAT, IELTS,TOEFL,TCF Preparation Curriculum",
                count: "Coming Soon",
              },
              {
                subject: "Personal Development Curriculum",
                count: "Coming Soon",
              },
              {
                subject: "Entrepreneurship & Innovation Curriculum",
                count: "Coming Soon",
              },
            ].map((item, index) => (
              <div
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 rounded-2xl p-8 text-center shadow-xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              Get updates from Scholora
            </h2>
            <p className="text-lg text-blue-100 mb-8 leading-relaxed max-w-2xl mx-auto">
              Stay in the loop about the latest expert opportunities and
              announcements.
            </p>
