      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {classes.map((cls) => (
              <div key={cls.id} className={`bg-white rounded-lg border border-gray-200 ${cls.borderColor} border-t-4`}>
                {/* Card Content */}
                <div className="p-6">
                  {/* Icon */}
                  <div className={`${cls.iconBg} w-12 h-12 rounded-lg flex items-center justify-center mb-4`}>
                    <span className="text-xl text-black font-semibold">{cls.icon}</span>
                  </div>
